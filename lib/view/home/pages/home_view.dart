...
import 'package:ba3_business_solutions/view/due/pages/due_type.dart';
...
import '../../card_management/pages/card_management_view.dart';
import '../../database/pages/database_type.dart';
                                                              ...
                                                              : ListView
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child: InkWell(
                                                                          onTap: () {
                                                                            HiveDataBase.mainAccountModelBox.put(model.accId,
                                                                                model);
                                                                            Get.back();
                                                                          },
                                                                          child: Padding(
