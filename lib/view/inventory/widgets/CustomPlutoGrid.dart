...
class CustomPlutoGrid extends StatelessWidget {
  const CustomPlutoGrid({super.key,
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PlutoViewModel>(builder: (controller) {
      return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          ...
          actions: [
            ...
            Padding(
                ...
                child: Text(
                    "عدد العناصر المتأثرة: ${modelList.isEmpty ? modelList
                        .length.toString() : modelList.length.toString()}")),
          ],
        ),
        body: PlutoGrid(
