                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                          "المجموع: " + invoiceList[index].invTotal.toString()),
                      Text("الوقت: " + invoiceList[index].invDate.toString()),
                      Text(
                          "البائع:  ${getSellerNameFromId(invoiceList[index].invSeller.toString())}"),
                      Text("المستودع: " +
                          getStoreNameFromId(
                              invoiceList[index].invStorehouse.toString())),
                      Text("من: " +
                          (invoiceList[index].invPrimaryAccount == null
                              ? "لا يوجد"
                              : getAccountNameFromId(invoiceList[index]
                                  .invPrimaryAccount
                                  .toString()))),
                      Text("الى: " +
                          (invoiceList[index].invSecondaryAccount == null
                              ? "لا يوجد"
                              : getAccountNameFromId(invoiceList[index]
                                  .invSecondaryAccount
                                  .toString()))),
                      ...
                      Text("رقم السند: " +
                          invoiceList[index].bondCode.toString()),
                    ],
                  ),
                  const SizedBox(
                    height: 15,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: Center(
                                  child:
                                      Text(e.invRecQuantity.toString() + " "))),
                          SizedBox(
                            width: 25,
                          ),
                          Container(
