      ...
      if (element[setting["accCode"]] != '') {
        ...
        if (accIsParent) {
          finalData.add(AccountModel(
            accId: getAccountIdFromText(
                element[setting["accName"]].replaceAll("-", "")),
            ...
            accVat: 'GCC',
            accParentId: accIsParent
                ? null
                : getAccountIdFromText(element[setting['accParentId']]),
