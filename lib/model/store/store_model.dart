...
class StoreModel {
  ...
  StoreModel.fromJson(Map<dynamic, dynamic> map) {
    List<StoreRecordModel>? stRecord = map['stRecords']
        ?.map<StoreRecordModel>((dynamic e) => StoreRecordModel.fromJson(e))
        .toList();
    stId = map['stId'];
    stCode = map['stCode'];
    stName = map['stName'];
  ...
  Map<String, dynamic> toFullJson() {
    return {
      ...
      'stCode': stCode,
      'stName': stName,
      "stRecords": stRecords.map((value) => value.toJson()).toList()
    };
  }
